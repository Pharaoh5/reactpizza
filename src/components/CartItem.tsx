...
import { addItem, minusItem, romoveItem, } from '../redux/slices/cartSlice.js'
...
const CartItem: React.FC<CartItemProps> = ({ id, title, price, imageUrl, count, tipe, size }) => {
